...
class Tag extends ApiAbstract
{
    /**
     * @var \Fawest\YaPhoto\Transport
     */
     ...
     * @param string $apiUrl
     */
    public function __construct(\Fawest\YaPhoto\Transport $transport, $apiUrl)
    {
     ...
     * @return null|\Fawest\YaPhoto\Api\PhotosCollection
     */
    public function getPhotosCollection()
    {
        $result = null;
        if (!empty($this->_apiUrlPhotos)) {
            $result = new \Fawest\YaPhoto\Api\PhotosCollection($this->_transport, $this->_apiUrlPhotos);
        }
        return $result;
    }
    ...
    /**
     * @return self
     * @throws \Fawest\YaPhoto\Exception\Api\Tag
     */
    public function load()
    {
        try {
            ...
            throw new \Fawest\YaPhoto\Exception\Api\Tag($ex->getMessage(), $ex->getCode(), $ex);
        }
