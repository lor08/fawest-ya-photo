...
use Fawest\YaPhoto\Exception\Api as ExceptionApi;
use Serializable;
...
abstract class ApiAbstract implements Serializable
{
    ...
    protected function _getData(Transport $transport, $apiUrl)
    {
        $error = true;
        $result = null;
        ...
        if ($error) {
            ...
            throw new ExceptionApi($msg, $tmp['code']);
        }
        return $result;
    }

    protected function _deleteData(Transport $transport, $apiUrl)
    {
        $error = true;
        $result = null;
    ...
    protected function _postData(Transport $transport, $apiUrl, array $data)
    {
        $error = true;
        $result = null;
